...
class BatchedLoader extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    invariant(prevProps.baseModel === this.props.baseModel, 'The BatchedLoader was not designed' +
      ' to handle prop changes after component mount. The baseModel prop changed after mount.')
    
    invariant(prevProps.params === this.props.params, 'The BatchedLoader was not designed' +
      ' to handle prop changes after component mount. The params prop changed after mount.')
  }

  render () {
    const { children } = this.props
    invariant(children, 'The BatchedLoader component must render a child component.')
